...
G2_WITHOUT_Z2_PROFILE = G2DynamicGatingProfile(
    key="g2_without_z2",
    experiment_id="C2-L03-MGDG-G2-WITHOUT-Z2-T1-S42",
    expected_branch="codex/g2-without-z2",
    expected_parent_branch="codex/g2-local-only",
    gating_input="concat_z4_z6",
    gating_input_semantics="concat([z4,z6])",
    experiment_label="G2-without-z2 Dynamic Gating",
    method_variant="g2_without_z2_per_sample_dynamic_gating",
    method="G2-without-z2 Dynamic Gating [z4,z6] -> [w4,w6]",
    config_filename=(
        "softmax_triplet_c2_l03_multi_granularity_dynamic_gating_"
        "g2_without_z2_autodl.yml"
    ),
    formal_result_filename="g2_without_z2_formal_result.json",
    formal_result_artifact_type="g2_without_z2_formal_result",
    analysis_directory_name="g2_without_z2_gating_analysis",
    analysis_manifest_filename="g2_without_z2_gating_analysis_manifest.json",
    artifact_prefix="g2_without_z2",
    controller_blocks=("z4", "z6"),
    active_scales=(4, 6),
    gate_weight_sum=1.0,
    required_analysis_artifacts=(
        "controller_block_norms_csv",
