...
EXPERIMENT_ID = "C2-L03-MGDG-G2-E-SD-A01-T0P5-S42"
...
DEFAULT_CONFIG = REPO_ROOT / "configs" / (
    ...
    "g2_e_static_dynamic_alpha0p1_tau0p5_autodl.yml"
)
...
def _configure_profile():
    ...
    recovery.FORMAL_RESULT_ARTIFACT_TYPE = "g2_e_static_dynamic_alpha0p1_tau0p5_formal_result"
    recovery.METHOD_VARIANT = "g2_e_static_concat_plus_gated_residual_alpha0p1_tau0p5"
    recovery.METHOD_LABEL = (
        "C2-L03 + G2-E static concat + gated residual "
        "[g,(1+0.1w2)z2,(1+0.1w4)z4,(1+0.1w6)z6]"
    )
    ...
    recovery.EXPECTED_STATIC_DYNAMIC_ALPHA = 0.1
