...
def verify(baseline_path, candidate_path):
    ...
    if float(_at(candidate, ("MODEL", "MULTI_GRANULARITY_STATIC_DYNAMIC_ALPHA"))) != 0.5:
        raise ProtocolError("G2-E residual alpha must be 0.5")
    ...
    return {
        ...
        "algorithm_variable": "static concatenation + gated residual, alpha=0.5; tau_g=0.5",
