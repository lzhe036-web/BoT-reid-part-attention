#!/usr/bin/env python
"""Recover and register completed G2-without-z4 evidence without retraining."""
...
EXPERIMENT_ID = G2_WITHOUT_Z4_PROFILE.experiment_id
EXPECTED_BRANCH = G2_WITHOUT_Z4_PROFILE.expected_branch
EXPECTED_GATING_INPUT = G2_WITHOUT_Z4_PROFILE.gating_input
...
def recover(config_path, output_dir, console_log, records_root, experiments_path,
    ...
    return _recover(
        ...
        runtime_seconds=runtime_seconds, profile=G2_WITHOUT_Z4_PROFILE,
    )
