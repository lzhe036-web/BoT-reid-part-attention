...
from tools.analyze_g2_e_static_dynamic_alpha0p1_tau0p5 import analyze
...
ALPHA = 0.1
TAU = 0.5
RESULT_FILENAME = "g2_e_static_dynamic_alpha0p1_tau0p5_formal_result.json"
ANALYSIS_DIRNAME = "g2_e_static_dynamic_alpha0p1_tau0p5_analysis"
...
def finalize(config_path, output_dir):
    ...
    from tools import recover_g2_e_static_dynamic_alpha0p1_tau0p5_experiment as profile
    ...
    result = {
        "experiment": "G2-E static concatenation plus gated residual (alpha=0.1, tau_g=0.5)",
        ...
        "fusion_formula": "concat(g,(1+0.1*w2)z2,(1+0.1*w4)z4,(1+0.1*w6)z6)",
        "descriptor_dim": 2816,
