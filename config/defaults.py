...
# Enable hierarchical anchor weighting and continuous hard-negative weighting
# for the camera-aware triplet branch.
_C.MODEL.HIERARCHICAL_CAMERA_AWARE_TRIPLET = False
_C.MODEL.HIERARCHICAL_CAMERA_AWARE_NEGATIVE_TEMPERATURE = 0.1
_C.MODEL.HIERARCHICAL_CAMERA_AWARE_EASY_WEIGHT = 0.5
_C.MODEL.HIERARCHICAL_CAMERA_AWARE_BOUNDARY_WEIGHT = 1.0
_C.MODEL.HIERARCHICAL_CAMERA_AWARE_HARD_WEIGHT = 1.5
