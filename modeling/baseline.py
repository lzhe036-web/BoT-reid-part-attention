...
class Baseline(nn.Module):
    ...
    def __init__(self, num_classes, last_stride, model_path, neck, neck_feat, model_name, pretrain_choice,
        ...
        # This is a configured scalar, not a Parameter: it is not learned.
    ...
    def forward(self, x):
        ...
        if self.multi_granularity_part:
            ...
            if self.multi_granularity_dynamic_gating:
                ...
                if self.multi_granularity_static_dynamic_residual:
                    # E1: z_final = [g, (1 + alpha*w2)z2,
                    #                 (1 + alpha*w4)z4, (1 + alpha*w6)z6].
                    # The controller sees the original, unweighted z values;
                    # no detach occurs in this gradient-carrying path.
                    ...
                    # Original G2 path, intentionally unchanged when E1 is off.
                    applied_scale_features = tuple(
