...
DEFAULT_SMOKE_OUTPUT_DIR="/root/autodl-tmp/experiments/BoT/c2_l03_mgdg_g2_without_z4_tau1_seed42_market1501_smoke"
...
[[ -z "$(git status --porcelain=v1 --untracked-files=all)" ]] || { echo "G2-without-z4 smoke requires a clean worktree." >&2; exit 1; }
